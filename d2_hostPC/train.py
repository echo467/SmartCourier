...
def collate_records(records, gen_records, opts):
    ...
    for record_path in records:
        ...
        #zd
        arrival = float(json_data["user/arrival"])
            ...
            for key in keys:
                ...
                if len(batch_data) == batch_size:
                    ...
                    for record in batch_data:
                        ...
                        # zd
                        arrival.append(record['arrival'])


                        out.append([record['angle'], record['throttle'], record['arrival']])
                    ...
                    if img_out:
                        ...
                        y = [np.array(angles), np.array(throttles), np.array(arrival)]
