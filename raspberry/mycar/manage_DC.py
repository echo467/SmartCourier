...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    #!!!
    V.add(communication, inputs=['arrive_signal'], outputs=['lock_state', 'car_state', 'pos'], threaded=True)
    # ********************************************* lock_ctr ********************************************
    ...
    V.add(PilotCondition(), inputs=['car_state'], outputs=['run_pilot', 'user/mode'])
    #zd d
...
# important
    ...
    class turn_delay_class:
        ...
        def run_threaded(self, arrival_signal, mode, has_arrived, pos, car_state):
    ...
    V.add(turn_delay, inputs=['pilot/arrival', 'user/mode', 'arrive_signal', 'pos', 'car_state'], outputs=['turn/mode', 'turn_direction', 'arrive_signal'], threaded=True)
    # ********************************************** turn_module ************************************************
